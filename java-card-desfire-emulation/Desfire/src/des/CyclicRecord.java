...
public class CyclicRecord extends File{
	...
	private boolean waitingToDeleteRecord;
	...
	public CyclicRecord(byte fid, DirectoryFile parent,byte[] accessPermissions, short recordSize, short maxSize) {
		super(fid,Util.CYCLIC_RECORD_FILE);
	...
	public void writeRecord(byte[] newData,short offset) {
		...
		parentFile.waitingForTransaction[this.getFileID()]=true;
		// copy new data to temporal record
		for (short i = 0; i < recordSize; i++) {
